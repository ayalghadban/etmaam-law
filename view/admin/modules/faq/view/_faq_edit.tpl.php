<?php
    ...
    * @copyright 2023
    * @version 6.20: _faq_edit.tpl.php, v1.00 5/9/2023 8:52 PM Gewa Exp $
    *
    */
...
<form method="post" id="wojo_form" name="wojo_form">
            ...
            <?php foreach ($this->langlist as $lang): ?>
               <div data-tab="lang_<?php echo $lang->abbr; ?>" class="item">
                     ...
                     <div class="field">
                        ...
                        <div class="wojo large basic input">
                           <input type="text" placeholder="<?php echo Language::$word->_MOD_FAQ_QUESTION; ?>"
                                  value="<?php echo $this->data->{'question_' . $lang->abbr}; ?>"
                  ...
                  <textarea class="altpost"
                            name="answer_<?php echo $lang->abbr; ?>"><?php echo Url::out_url($this->data->{'answer_' . $lang->abbr}); ?></textarea>
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
   ...
   <div class="center-align">
      ...
      <button type="button" data-route="admin/modules/faq/action/" data-action="update" name="dosubmit"
              class="wojo primary button"><?php echo Language::$word->_MOD_FAQ_UPDATE; ?></button>
   </div>
