      ...
      <div class="row big gutters align-middle">
         <div class="columns screen-40 tablet-50 mobile-100 phone-100">
            <div class="container">
               ...
               <p>Intelligent developers use our CMS Pro theme to build their internal tools and client admin applications. Save yourself time and money. </p>
               <a href="#!" class="wojo primary big spaced right button">
                  <span>Start For Free</span>
                  <i class="icon long arrow right"></i>
               </a>
               <a href="#!" class="wojo secondary big button">Learn More</a>
            </div>
         </div>
         <div class="columns screen-60 tablet-50 mobile-100 phone-100">
            <div class="container relative">
               <figure class="wojo skewed image zi1">
                  <img src="[SITEURL]uploads/images/builder/dashkit.jpg" alt="Image Description">
               </figure>
