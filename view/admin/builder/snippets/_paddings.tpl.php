<?php
    ...
    * @copyright 2023
    * @version 6.20: _paddings.tpl.php, v1.00 5/8/2023 9:18 AM Gewa Exp $
    *
    */
...
<div class="wojo small block fields">
   <div class="field">
      <label>Padding Screen</label>
      <div class="wojo vertical buttons" id="paddings_device">
   ...
   <div class="field">
      ...
      <div class="wojo vertical buttons" id="paddings_size">
         <div class="wojo wojo mini fluid buttons">
   ...
   <div class="field" id="paddings_directions">
      <label>Padding Directions</label>
   ...
   <div class="field">
      <a class="wojo mini fluid primary button" id="addPadding">Add Padding</a>
   </div>
   <div class="field basic">
      <div class="wojo vertical buttons" id="paddings_container"></div>
   </div>
</div>