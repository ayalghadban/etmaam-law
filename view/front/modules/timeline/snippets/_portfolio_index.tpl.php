<?php
    ...
    * @var object $settings
    * @var object $result
    * @version 6.20: _portfolio_index.tpl.php, v1.00 12/5/2023 2:12 PM Gewa Exp $
    *
    */
            ...
            <?php if (count($row->thumb) > 1): ?>
               <div class="wojo carousel" data-wcarousel='{"autoplay":false,"dots":false,"loop":true, "arrows": true}'>
                  <?php foreach ($row->thumb as $img): ?>
                     <img src="<?php echo $img; ?>" alt="<?php echo $row->title; ?>" class="rounded-top">
                  <?php endforeach; ?>
               </div>
            <?php else: ?>
               <a href="<?php echo $row->link; ?>">
                  <img src="<?php echo $row->thumb[0]; ?>" alt="<?php echo $row->title; ?>" class="rounded-top">
               </a>
            <?php endif; ?>
