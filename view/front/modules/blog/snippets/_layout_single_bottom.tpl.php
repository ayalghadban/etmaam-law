<?php
   /**
    * _layout_single_bottom
    *
    * @package Wojo Framework
    * @author wojoscripts.com
    * @copyright 2023
    * @version 6.20: _layout_single_bottom.tpl.php, v1.00 10/20/2023 2:26 PM Gewa Exp $
    *
    */
...
<?php if (Blog::getMembershipAccess($this->row->membership_id)): ?>
   <h3 class="margin-bottom"><?php echo $this->row->{'title' . Language::$lang}; ?></h3>
   ...
   <div class="wojo horizontal relaxed divided list">
      <?php if ($this->row->show_author): ?>
         <div class="item">
            <span class="text-weight-500 intro"><?php echo Language::$word->BY; ?>:</span>
      ...
      <?php endif; ?>
      <div class="item">
         <span class="text-weight-500 intro"><?php echo Language::$word->IN; ?>:</span>
      ...
      <div class="item">
         <span class="text-weight-500 description"><?php echo Language::$word->_MOD_AM_SUB44; ?>:</span>
