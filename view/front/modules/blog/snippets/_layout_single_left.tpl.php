      ...
      <div class="columns screen-50 tablet-100 mobile-100 phone-100">
         ...
         <?php else: ?>
            <a href="<?php echo FMODULEURL . Blog::BLOGDATA . $this->row->id . '/' . $this->row->thumb; ?>" data-title="<?php echo $this->row->caption; ?>" class="wojo basic rounded image lightbox">
               <img src="<?php echo Blog::hasThumb($this->row->thumb, $this->row->id); ?>" alt="<?php echo $this->row->{'title' . Language::$lang}; ?>">
            </a>
         <?php endif; ?>
      </div>
      <div class="columns screen-50 tablet-100 mobile-100 phone-100">
         <div class="wojo small relaxed list align-middle">
            ...
            <?php if ($this->row->show_like): ?>
               ...
               <div class="item">
                  ...
                  <div class="content">
                     <a class="blogLike description" data-id="<?php echo $this->row->id; ?>" data-url="<?php echo SITEURL; ?>" data-vote="up">
               ...
               <div class="item">
                  ...
                  <div class="content">
                     <a class="blogLike description" data-id="<?php echo $this->row->id; ?>" data-url="<?php echo SITEURL; ?>" data-vote="down">
