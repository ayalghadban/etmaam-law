(function ($R) {
   $R.add('plugin', 'fullscreen', {
      ...
      start: function () {
         ...
         const button = this.toolbar.addButton('fullscreen', data);
      ...
      open: function () {
         ...
         const $html = (this.toolbar.isTarget()) ? $R.dom('body, html') : this.$target;
      ...
      _resize: function () {
         ...
         const $editor = this.editor.getElement();
         const height = this.$win.height() - $toolbar.height();
