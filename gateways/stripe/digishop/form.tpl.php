<?php
    ...
    * @copyright 2023
    * @version 6.20: form.tpl.php, v1.00 6/27/2023 1:08 PM Gewa Exp $
    *
    */
                  ...
                  success: function(json) {
                     ...
                     if (json.type === 'success') {
                        $('body').transition('scaleOut', {
                           duration: 4000,
                           complete: function() {
                              window.location.href = '<?php echo Url::url($this->core->system_slugs->account[0]->{'slug' . Language::$lang}, 'digishop');?>';
                           }
                        });
                     }
                     if (json.message) {
