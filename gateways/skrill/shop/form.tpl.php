<?php
    ...
    * @copyright 2023
    * @version 6.20: form.tpl.php, v1.00 12/2/2023 9:33 AM Gewa Exp $
    *
    */
...
<form action="https://www.skrill.com/app/payment.pl" method="post" id="mb_form" name="mb_form" class="center-align">
   ...
   <input type="hidden" name="return_url" value="<?php echo Url::url($this->core->system_slugs->account[0]->{'slug' . Language::$lang}, 'shop'); ?>">
   <input type="hidden" name="cancel_url" value="<?php echo Url::url($this->core->system_slugs->account[0]->{'slug' . Language::$lang}, 'shop'); ?>">
