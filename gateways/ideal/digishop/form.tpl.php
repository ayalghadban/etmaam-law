<?php
    ...
    * @copyright 2023
    * @version 6.20: form.tpl.php, v1.00 6/27/2023 1:14 PM Gewa Exp $
    *
    */
   ...
   try {
      ...
      $this->db->update(Digishop::qTable, array('cart_id' => $payment->id, 'order_id' => $order_id))->where('user_sid', $this->auth->sesid, '=')->run();
