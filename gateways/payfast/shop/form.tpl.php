<?php
    ...
    * @copyright 2023
    * @version 6.20: form.tpl.php, v1.00 12/2/2023 9:25 AM Gewa Exp $
    *
    */
...
<form action="https://<?php echo $url; ?>/eng/process" class="center aligned" method="post" id="pf_form" name="pf_form">
   ...
   <?php
      ...
      $array = array(
        ...
        'return_url' => Url::url($this->core->system_slugs->account[0]->{'slug' . Language::$lang}, 'shop'),
        'cancel_url' => Url::url($this->core->system_slugs->account[0]->{'slug' . Language::$lang}, 'shop'),
