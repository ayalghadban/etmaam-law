<?php
    ...
    * @copyright 2023
    * @version 6.20: form.tpl.php, v1.00 6/27/2023 9:12 AM Gewa Exp $
    *
    */
...
<form action="https://<?php echo $url; ?>/cgi-bin/webscr" method="post" id="pp_form" name="pp_form" class="center-align">
   ...
   <input type="hidden" name="return" value="<?php echo Url::url($this->core->system_slugs->account[0]->{'slug' . Language::$lang}, 'digishop'); ?>">
   <input type="hidden" name="rm" value="2"/>
   <input type="hidden" name="notify_url" value="<?php echo SITEURL . 'gateways/' . $this->gateway->dir . '/digishop/ipn.php;' ?>">
   <input type="hidden" name="cancel_return" value="<?php echo Url::url($this->core->system_slugs->account[0]->{'slug' . Language::$lang}, 'digishop'); ?>">
