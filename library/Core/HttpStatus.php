<?php
     ...
     * @copyright 2024
     * @version 6.20: HttpStatus.php, v1.00 1/7/2024 10:40 AM Gewa Exp $
     *
     */
    ...
    class HttpStatus
    {
        ...
        public function __construct(int $status_code)
        {
            if (!in_array($status_code, array_keys($this->http_status))) {
                throw new InvalidArgumentException(sprintf('The code %d is not a valid HTTP status code. View "https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml" for more info.', $status_code));
            }
